var icon_img = '../../src/assets/images/Leo.png'
var playAd = 0;
var bye = 0;
...
function createQuestions() {
	...
	prescripted_questions[3] = new Question(["../../src/assets/images/LEGOGIF1.gif"], [""], 4, 0);
	...
	prescripted_questions[6] = new Question(["../../src/assets/images/LEGOGIF2.gif"], [""], 7, 0);
	...
	if(answer_text == answer[correct_index]) {
		if(next_question > -1) {
			...
			if(text.indexOf('gif') > -1) {
		    	...
		    	newNode.appendChild(document.createTextNode("  Leo is typing..."));
			...
			setTimeout(function() {
				postImage('../../src/assets/images/LEGOGIF3.gif');
			}, 4000);
		}
}
	}
...
function displayBot()
{
	...
	if(user_name == '') {
		setTimeout(function() {
		    postBotAnswer("Hi! I am Leo, LEGO’s chatbot powered by artificial intelligence! What’s your name?")
		}, 500);
	}
}
